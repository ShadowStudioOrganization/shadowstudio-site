! function() {    
    ...
    function get_config_option() {    
        ...
        return {    
            ...
            c: get_attribute(script, "color", "140, 0, 255"), //color    
    ...
    function draw_canvas() {    
        img = new Image();
        img.src = 'static/images/pearl.png';
        ...
        random_lines.forEach(function(r) {    
            ...
            context.drawImage(img,r.x-10, r.y-10,20,20); //绘制一个宽高为1的点    
